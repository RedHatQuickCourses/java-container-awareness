...
This course is fully based on the current OpenJDK implementation and the article [How to use Java container awareness in OpenShift 4](https://developers.redhat.com/articles/2024/03/14/how-use-java-container-awareness-openshift-4).

...
Note: When deploying with an Operator, the Operator will control the deployment directly, the user needs to modify the settings via the respective Custom Resource.

...
+
[source,bash]sudo docker run -p 8081:8080 -e MY_VARIABLE=my_value openjdk-hotrod:example
----
...
----
$ jcmd
1 /deployments/hotrodspringboot-0.0.1-SNAPSHOT.jar <--- java application
179 jdk.jcmd/sun.tools.jcmd.JCmd 
----
...
[source,bash]
----
oc set resources deployment/my-java-app --requests=cpu=1000m --limits=cpu=2000m
----
